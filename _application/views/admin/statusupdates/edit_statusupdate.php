...
?>
 ...
 <div id="statusupdate_form">
  ...
  <form method="post" name="f_exp" id="f_exp" action="admin/statusupdates/edit/<?=$id?>">
   <input type="hidden" name="submit_form" value="1">
   <input type="hidden" name="int_start_date" value="<?=$form->data['int_start_date']?>">
   <input type="hidden" name="status" value="<?=$form->data['status']?>">
   <input type="hidden" name="resolution" value="<?=$form->data['resolution']?>">
   <input type="hidden" name="resolved_date" value="<?=$form->data['resolved_date']?>">
