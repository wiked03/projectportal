...
class Expense extends CORE_Model
{
  // ----------------------------------------------------------------------------------------
  function Expense( $id=0, $create_form=true )
  {
    $this->id = $id;
